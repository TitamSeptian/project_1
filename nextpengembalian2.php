  ...
  <div class="content" align="">
      <div class="login-box">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Lebih Hari">
          <small id="emailHelp" class="form-text text-muted"><a href="nextpengembalian2.php">lihat denda</a></small>
        </div>

        

        <div class="" align="center">
        <a href="riwayat.php"><button type="button" class="btn btn-dark"><b>Verifikasi</b></button></a>
