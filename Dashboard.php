    ...
    <div class="container marketing" style="margin-top: 50px;">
      <div class="row">
            <div class="col"><center>
              ...
              <h2>List Buku</h2>
              <p>Klik tombol lihat untuk melihat buku yang terdaftar pada List Buku.</p>
              <p><a class="btn btn-dark" href="list-buku.html" role="button">Lihat &raquo;</a></p>
            </center></div><!-- /.col-lg-4 -->
          <div class="col"><center>
            ...
            <p>Klik tombol Kelola untuk melanjutkan ke halaman Kelola Peminjaman.</p>
            <p><a class="btn btn-dark" href="kelola-peminjaman.html" role="button">Kelola &raquo;</a></p>
          </center></div><!-- /.col-lg-4 -->
          <div class="col"><center>
            ...
            <p>Klik tombol kelola untuk melanjutkan ke halaman Kelola Pengembalian.</p>
           <p><a class="btn btn-dark" href="kelola-pengembalian.html" role="button">Kelola &raquo;</a></p>
        </center></div><!-- /.col-lg-4 -->
        <div class="col"><center>
            <img class="rounded-circle" src="resources/img/user_dashboard.png" alt="Generic placeholder image" width="140" height="140">
            <h2>Data Anggota</h2>
            <p> Klik tombol lihat untuk melihat Data Anggota yang terdaftar.</p>
           <p><a class="btn btn-dark" href="data-anggota.html" role="button">Lihat &raquo;</a></p>
        </center></div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
    </div>
